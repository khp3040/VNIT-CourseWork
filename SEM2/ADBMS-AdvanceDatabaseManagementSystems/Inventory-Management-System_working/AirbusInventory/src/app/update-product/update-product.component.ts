...
const unitsValue = parseFloat(this.units?.value ?? '0');

// Assign the number value to the product.units property
this.product.units = unitsValue;

    // this.product.units=this.units?.value ?? 0;
