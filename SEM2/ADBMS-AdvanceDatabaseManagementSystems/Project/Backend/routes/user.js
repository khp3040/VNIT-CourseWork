        ...
        if(!err){
            if(results.length <= 0)
            {
                ...
                var mailOptions ={
                    ...
                    html:'<p><b>Your Login details for Inventory Management System</b><br><b>Email:</b>'+results[0].email+'<br><b>Password: </b>'+results[0].password+'<br><a href="http://localhost:4200/">Click here to login.</a></p>'
                };
